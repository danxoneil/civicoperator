...
SOURCE = {
 ...
 "Idaho":"https://publicdocuments.dhw.idaho.gov/WebLink/DocView.aspx?id=35012&dbid=0&repo=PUBLIC-DOCUMENTS",
...
MAPS = {
 ...
 "Idaho":("map-idaho.png","DHW federally-defined rural-areas map."),
